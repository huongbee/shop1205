                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2 col-sm-4 col-xs-12">
                        <div class="item product-01">
                          ...
                          <a href="{{route('menu-detail',[$thucdon->id])}}"><h5 class="title">{{$thucdon->name}}</h5><span class="price woocommerce-Price-amount amount"><span class="price-symbol">vnđ</span>{{number_format($thucdon->price)}}</span></a>
                        </div>
                      </div>
                      @endforeach
                    </div>
